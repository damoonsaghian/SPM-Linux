...
# findfs findmnt mkswap swapon swapoff eject losetup fallocate wipefs flock fstrim
# dmesg setpriv pivot_root switch_root unshare hwclock
# rfkill taskset
# renice rtcwake
# disable: su runuser login agetty mcookie logger partx cfdisk setarch lscpu lsmem ...

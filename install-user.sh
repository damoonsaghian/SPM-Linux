...
# after 600 seconds idle, lock (using system timer service)
# dim screen in several steps before locking
# exec /usr/local/bin/lock

# console level keybinding: when "F1" or "XF86Lock" is pressed: /usr/local/bin/lock
